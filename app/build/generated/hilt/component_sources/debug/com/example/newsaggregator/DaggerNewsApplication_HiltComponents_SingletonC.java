...
import com.example.newsaggregator.di.AppModule_ProvideNewsRepositoryFactory;
import com.example.newsaggregator.di.AppModule_ProvideRetrofitFactory;
import com.example.newsaggregator.di.AppModule_ProvideRssFeedFactory;
import com.example.newsaggregator.domain.repository.NewsRepository;
import com.example.newsaggregator.ui.MainActivity;
import com.example.newsaggregator.ui.viewmodel.NewsViewModel;
import com.example.newsaggregator.ui.viewmodel.NewsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerNewsApplication_HiltComponents_SingletonC {
  ...
  public static NewsApplication_HiltComponents.SingletonC create() {
  ...
  private static final class ViewModelCImpl extends NewsApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.newsaggregator.ui.viewmodel.NewsViewModel", ((Provider) newsViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.newsaggregator.ui.viewmodel.NewsViewModel 
          return (T) new NewsViewModel(singletonCImpl.provideNewsRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends NewsApplication_HiltComponents.SingletonC {
    ...
    private Provider<RssFeed> provideRssFeedProvider;
    ...
    private void initialize() {
      ...
      this.provideRssFeedProvider = DoubleCheck.provider(new SwitchingProvider<RssFeed>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.newsaggregator.domain.repository.NewsRepository 
          return (T) AppModule_ProvideNewsRepositoryFactory.provideNewsRepository(singletonCImpl.provideRssFeedProvider.get());

          case 1: // com.example.newsaggregator.data.rss.RssFeed 
          return (T) AppModule_ProvideRssFeedFactory.provideRssFeed(singletonCImpl.provideRetrofitProvider.get());
