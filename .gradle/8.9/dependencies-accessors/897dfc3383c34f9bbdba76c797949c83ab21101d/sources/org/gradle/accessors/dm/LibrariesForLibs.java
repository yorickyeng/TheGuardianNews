...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>xmlutil</b>
     */
    public XmlutilLibraryAccessors getXmlutil() {
        return laccForXmlutilLibraryAccessors;
    }
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hilt.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class XmlutilLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>io.github.pdvrieze.xmlutil:core</b> coordinates and
         * with version reference <b>xmlUtil</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("xmlutil.core");
        }

        /**
         * Dependency provider for <b>serialization</b> with <b>io.github.pdvrieze.xmlutil:serialization</b> coordinates and
         * with version reference <b>xmlUtil</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSerialization() {
            return create("xmlutil.serialization");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coilVersion</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>junit</b> with value <b>4.14-SNAPSHOT</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>recyclerviewVersion</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>xmlUtil</b> with value <b>0.91.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getXmlUtil() { return getVersion("xmlUtil"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hilt.version</b> with value <b>2.49</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KspVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ksp.version</b> with value <b>2.0.0-1.0.24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
